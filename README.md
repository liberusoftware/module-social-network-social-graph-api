...
[![Latest release](https://img.shields.io/github/v/release/liberusoftware/module-social-network-social-graph-api?sort=semver)](https://github.com/liberusoftware/module-social-network-social-graph-api/releases/latest) [![Tests](https://github.com/liberusoftware/module-social-network-social-graph-api/actions/workflows/tests.yml/badge.svg?branch=main)](https://github.com/liberusoftware/module-social-network-social-graph-api/actions/workflows/tests.yml)
...
```bash
composer require liberusoftware/module-social-network-social-graph-api
```
...
<a href="https://github.com/liberusoftware/module-social-network-social-graph-api/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=liberusoftware/module-social-network-social-graph-api" alt="Contributors to liberusoftware/module-social-network-social-graph-api">
</a>

[View the full contributors graph](https://github.com/liberusoftware/module-social-network-social-graph-api/graphs/contributors).
